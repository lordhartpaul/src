...
public class label1 extends Applet
{
	...
	{
		setLayout(null);
		setBackground(new java.awt.Color(168,168,213));
		setSize(569,524);
		add(textField1);
		...
		add(textField6);
		textField6.setBackground(java.awt.Color.white);
		...
		add(textField12);
		textField12.setBackground(java.awt.Color.white);
		...
		add(textField11);
		textField11.setBackground(java.awt.Color.white);
		textField11.setBounds(120,300,410,18);
		add(label19);
		label19.setFont(new Font("Dialog", Font.BOLD, 16));
		label19.setForeground(new java.awt.Color(213,110,213));
